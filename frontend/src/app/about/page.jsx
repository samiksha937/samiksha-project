    ...
    <div className="bg-neutral-900">
        <div className="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24">
            <h1 className="font-semibold text-white text-5xl md:text-6xl">
                <span className="text-[#ff0] ">ABOUT US</span> :MARKETPLACE FOR
                SELLING UI/UX DESIGN
            </h1>
            <div className="max-w-4xl">
                <p className="mt-5 text-neutral-400 text-lg">

                    Welcome to MARKETPLACE FOR SELLING UI/UX DESIGN , your go-to platform for downloading high-quality UI/UX designs.
                    We are passionate about connecting users and businesses that need visually stunning and user-friendly designs
                    for their websites and apps.

                    Our marketplace offers a wide range of creative, easy-to-use designs that can enhance any project. Whether you're a
                    designer looking to showcase your work and reach a global audience, or a developer searching for the perfect design
                    to bring your project to life, we’ve got you covered.

                    At MARKETPLACE FOR SELLING UI/UX DESIGN, we believe that great design is the key to creating memorable user experiences.
                    That’s why we are committed to offering a collection of some good designs that are visually appealing.

                    Join us today to explore a world of creativity, find the right design for your project, or share your work with
                    a wider audience. Let’s make great design accessible to everyone!
